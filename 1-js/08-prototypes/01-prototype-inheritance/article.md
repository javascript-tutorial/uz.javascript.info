...
_Prototipal meros_ - bunga yordam beradigan til xususiyati.
...
```smart header="`**proto**` `[[Prototype]]`uchun tarixiy qabul qiluvchi/belgilovchi"
Iltimos,`**proto**`  `[[Prototype]]` bilan _bir xil emas_. Bu u uchun getter/setter.
